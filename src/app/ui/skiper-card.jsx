...
function FeatureCard({
  ...
  return (
    (<motion.div
      ...
      <div
        className={cn(
          "group relative w-full overflow-hidden rounded-3xl border border-black/10  from-neutral-900/90 to-stone-800 transition duration-300 dark:from-neutral-950/90 dark:to-neutral-800/90",
